/*
 * toad_ally.js
 * * Defines the custom map logic for "CustomMap_ToadAlly".
 * The function name must be World + MapName + LocationIndex (WorldCustomMap_ToadAlly0)
 * to be correctly found by the game's setMap function.
 */

function WorldCustomMap_ToadAlly0(map) {
  // Ensure the map object has the required properties initialized
  map.locs = [];
  map.areas = [];
  ...
  // --- Map Areas (The actual world content) ---
  map.areas = [
    // Area 0: Overworld Alt
